...
public class ShareUtil {
  ...
  public void shareQzone(Activity activity, String text, UMImage umImage, String url, UMShareListener umShareListener) {
    new ShareAction(activity)
  ...
  public void shareWx(Activity activity, String text, UMImage umImage, String url, UMShareListener umShareListener) {
    new ShareAction(activity)
  ...
  public void shareSina(Activity activity, String text, UMImage umImage, String url, UMShareListener umShareListener) {
    new ShareAction(activity)
