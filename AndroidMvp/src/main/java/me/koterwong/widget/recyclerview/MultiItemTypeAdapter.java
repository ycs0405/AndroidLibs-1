/*
 * MultiTypeAdapter     2016/9/28-09-28
...
import me.koterwong.widget.recyclerview.base.ItemViewDelegateManager;

/**
 * Created by Koterwong on 2016/9/28 18:42
 */
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
  ...
  @Override public int getItemViewType(int position) {
    if (!useItmeViewDelegateManager()) return super.getItemViewType(position);
    return mItemViewDelegateManager.getItemViewType(mDatas.get(position), position);
  }

  protected boolean useItmeViewDelegateManager() {
    ...
    viewHolder.getConvertView().setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (mOnItemClickListener != null) {
          // TODO: 2016/11/21 如果有headerview ，位置要减去headerview的高度
