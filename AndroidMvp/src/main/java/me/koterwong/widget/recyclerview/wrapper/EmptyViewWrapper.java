/*
 * EmptyViewWrapper     2016/9/29-09-29
...
/**
 * Created by Koterwong on 2016/9/29 10:13
 */
public class EmptyViewWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public EmptyViewWrapper(View emptyView, RecyclerView.Adapter innerAdapter) {
    mEmptyView = emptyView;
    mInnerAdapter = innerAdapter;
  }

  public EmptyViewWrapper(RecyclerView.Adapter innerAdapter, int emptyLayoutId) {
    mInnerAdapter = innerAdapter;
