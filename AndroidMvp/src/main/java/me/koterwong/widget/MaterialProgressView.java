/*
 * MaterialProgressView     2016/10/2-10-02
...
/**
 * Created by Koterwong on 2016/10/2 09:19
 */
public class MaterialProgressView extends RelativeLayout {
  private static final int[] colors = {0xFF4081, 0x536dfe, 0xFF4081};
  ...
  public MaterialProgressView(Context context, AttributeSet attrs, int defStyleAttr, int
      defStyleRes) {
